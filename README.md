# Chat Assistant
Welcome to Chat Assistant with context. This repository is part of a challenge of A+ Educação available on [this link](https://github.com/grupo-a/challenge-artificial-intelligence/tree/main/resources).
